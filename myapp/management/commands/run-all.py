...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dashboards = [
            ...
            ("content_performance.py", 8535),
            ("monetization_dashboard.py", 8536),
            ("inorganic1.py", 8537),
            ("inorganic2.py", 8538),
            ("inorganic3.py", 8539),
            ("linkedin_operational.py", 8540),
            ("linkedin_tactical.py", 8541),
            ("linkedin_strategic.py", 8542),
            ("facebook_operational.py", 8543),
            ("facebook_tactical.py", 8544),
            ("facebook_strategic.py", 8545),
            ("cm_operational.py", 8546),
            ("cm_tactical.py", 8547),
            ("cm_strategic.py", 8548),
            ("inorganic_operational.py", 8549),
            ("inorganic_tactical.py", 8550),
            ("inorganic_strategic.py", 8551),
        ]
